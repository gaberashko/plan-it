...
class TaskList {
    ...
    public addTask(): void {
        ...
        let descInput = document.querySelector("#taskDescription") as HTMLInputElement;
    ...
    private editTask(index: number): void {
        let titleInput = document.querySelector(`#editTaskName${index}`) as HTMLInputElement;
        let descInput = document.querySelector(`#editTaskDescription${index}`) as HTMLInputElement;
        let dateInput = document.querySelector(`#editTaskDate${index}`) as HTMLInputElement;
        let priorityInput = document.querySelector(`#editPriority${index}`) as HTMLInputElement;
